...
const { timestampsLastHour, timestampsByHour, signinsOfDay, occupancyOfDay, currentOccupancy, insertCurrentTime } = require("./serverUtils");
...
app.get("/signins/", async (req, res) => {
  try {
    ...
    if (isNaN(granularity) || granularity < minGranularity || granularity > maxGranularity) {
